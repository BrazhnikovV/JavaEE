        ...
        <div class="col-md-12">
            <form action="product-save" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" value="<%= product.getName() %>" class="form-control" id="exampleInputText" aria-describedby="emailHelp" placeholder="Enter name">
                </div>
                <div class="form-group">
                    <label for="exampleInputDescription">Description</label>
                    <input type="text" name="description" value="<%= product.getDescription() %>" class="form-control" id="exampleInputDescription" aria-describedby="emailHelp" placeholder="Enter name">
                </div>
